...
const Game = (props) => {
  ...
  return (
    <div style={{ flex: 2, backgroundColor: "#bbcdc7", padding: "20px", borderRadius: "10px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)" }}>
      <h1 style={{ textAlign: "center", color: "white"  }}>The Explosive Online Game Experience</h1>
      {cards?.length > 0 ? (
        <>
          ...
          {activeCard ? (
            <h1 style={{ marginTop: "340px", textAlign: "center", color: "white" }}>
  ...
  <span style={{ marginLeft: "10px" }}>Loading new game...</span>
      ...
      {score ? (
        ...
        <h1 style={{ marginTop: "100px", textAlign: "center", color: "white" }}></h1>
      )}
    </div>
  );
};
